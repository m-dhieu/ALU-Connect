...
class OpportunityDetailsScreen extends StatelessWidget {
                        ...
                        Row(
                          children: [
                            Container(
                              width: 44,
                              height: 44,
                              decoration: BoxDecoration(color: startupThemeColor, borderRadius: BorderRadius.circular(12)),
                              alignment: Alignment.center,
                              child: Text(
                                opportunityData['logoInit'] ?? 'ZH',
                ...
                child: isAlreadyApplied
                    ? Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.inter(color: const Color(0xFF137333), fontSize: 16, fontWeight: FontWeight.bold),
                        ),
                      )
                    : ElevatedButton(
                        onPressed: () {
                        ...
                        child: Text(
                          'Apply Now • ${opportunityData['spotsLeft'] ?? "1 spot left"}',
  ...
  Widget _buildGridMetadataCell(String label, String value, {bool isLast = false}) {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(border: isLast ? null : Border(right: BorderSide(color: Colors.grey.shade200, width: 1))),
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(label, textAlign: TextAlign.center, style: GoogleFonts.inter(color: Colors.grey.shade400, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
            const SizedBox(height: 6),
            Text(value, textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis, style: GoogleFonts.inter(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w900)),
          ],
        ),
      ),
    );
  ...
  Widget _buildCapabilityTag(String skillLabel) {
    return Container(
      ...
      child: Text(skillLabel, style: GoogleFonts.inter(color: Colors.grey.shade800, fontSize: 13, fontWeight: FontWeight.w600)),
    );
  }
  ...
  void _showApplicationBottomSheet(BuildContext context) {
    ...
    const int maxCharacterLimit = 500;
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setModalState) {
            return Padding(
              padding: EdgeInsets.only(top: 12.0, left: 24.0, right: 24.0, bottom: MediaQuery.of(context).viewInsets.bottom + 24.0),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text('Apply to ${opportunityData['companyName'] ?? "Zuri Health"}', style: GoogleFonts.inter(color: Colors.black, fontSize: 24, fontWeight: FontWeight.w900)),
                  const SizedBox(height: 4),
                  Text(opportunityData['roleTitle'] ?? 'Product Design Intern', style: GoogleFonts.inter(color: Colors.grey.shade500, fontSize: 15, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 28),
                  Text('WHY ARE YOU A GREAT FIT? *', style: GoogleFonts.inter(color: Colors.grey.shade700, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Share your relevant experience, what excites you about this role, and what you hope to contribute...',
                      hintStyle: GoogleFonts.inter(color: Colors.grey.shade400, fontSize: 14, height: 1.4),
                      counterText: '',
                      filled: true,
                  ...
                  Text('$currentCharacterCount/$maxCharacterLimit characters', style: GoogleFonts.inter(color: Colors.grey.shade400, fontSize: 12, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 24),
                  SizedBox(
                    width: double.infinity,
                    height: 56,
                    child: ElevatedButton(
                      ...
                      child: Text(
                        'Submit Application',
                        style: GoogleFonts.inter(color: currentCharacterCount == 0 ? Colors.white70 : Colors.white, fontSize: 16, fontWeight: FontWeight.bold),
                      ),
                    ),
                  ),
                ],
